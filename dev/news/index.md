...
- Adds `cuda_get_device_properties(device)` that allows one to query
  ...
  [@rdinnager](https://github.com/rdinnager))
- Implemented
  [`call_torch_function()`](https://cregouby.github.io/torch/dev/reference/call_torch_function.md)
...
- Added
  ...
  and
  [`get_install_libs_url()`](https://cregouby.github.io/torch/dev/reference/install_torch_from_file.md)for
...
- Internal refactoring making Rcpp aware of some XPtrTorch\* types so
  ...
  [`torch_dtype()`](https://cregouby.github.io/torch/dev/reference/torch_dtype.md)
  being an R6 class.
