...
[`torch::install_torch()`](https://cregouby.github.io/torch/dev/reference/install_torch.md).
...
matrix](https://cregouby.github.io/torch/dev/articles/compatibility-matrix)
