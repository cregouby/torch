...
[`lobstr::mem_used()`](https://lobstr.r-lib.org/reference/mem_used.html)
...
use
[`torch::cuda_memory_summary()`](https://cregouby.github.io/torch/dev/reference/cuda_memory_stats.md)
...
[pytorch.org/memory_viz](https://cregouby.github.io/torch/dev/articles/pytorch.org/memory_viz).
