...
| `Tuple[T0, T1, ..., TN]` | A [`list()`](https://rdrr.io/r/base/list.html) containing subtypes `T0`, `T1`, etc. wrapped with [`jit_tuple()`](https://cregouby.github.io/torch/dev/reference/jit_tuple.md) . |
...
| `T` | Not yet supported. |
| `E` | Not yet supported. |
| `NamedTuple[T0, T1, ...]` | A named list containing subtypes `T0`, `T1`, etc. wrapped in [`jit_tuple()`](https://cregouby.github.io/torch/dev/reference/jit_tuple.md). |
