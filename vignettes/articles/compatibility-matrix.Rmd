...
|:------------:|:---------------------------:|
|     12.8     |      0.16.x to 0.17.x       |
|     12.6     |      0.16.x to 0.17.x       |
...
<script>
  ...
  const compatibility = {
    ...
    "12.6": { torch_range: "0.16.x to 0.17.x", rec_version: "0.17.0", linux_only: false },
    "12.8": { torch_range: "0.16.x to 0.17.x", rec_version: "0.17.0", linux_only: false }
  };
